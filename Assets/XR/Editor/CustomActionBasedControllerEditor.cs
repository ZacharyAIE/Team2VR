...
{
    /// <summary>
    /// Custom editor for an <see cref="CustomActionBasedController"/>.
    /// </summary>
    [CustomEditor(typeof(CustomActionBasedController), true), CanEditMultipleObjects]
    [MovedFrom("UnityEngine.XR.Interaction.Toolkit")]
    public class CustomActionBasedControllerEditor : XRBaseControllerEditor
    {
        ...
        protected static class Contents
        {
            ...
            public static GUIContent leftControllerBool = EditorGUIUtility.TrTextContent("Is Left Controller?", "Please let this work");
