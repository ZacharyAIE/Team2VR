...
namespace CharacterComparison
{
    ...
    public class ShipEditor : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.PropertyField(statRect, property.FindPropertyRelative(nameof(ShipType._shipType)), GUIContent.none);
            EditorGUI.PropertyField(valueRect, property.FindPropertyRelative(nameof(ShipType._maxCargo)), GUIContent.none);
